...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div class="md:max-w-96">
            ...
            <p class="mt-6 text-sm" >
                Experience the power of AI with QuickAi. <br/>Transform your content creation with our suite of perimum AI tools. Write articles , Generate images , and enhance your worlflow
            </p>
        </div>
        <div className="flex-1 flex items-start md:justify-end gap-20">
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div classn="flex items-center gap-2 pt-4">
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © LunaStack All Right Reserved.
    </p>
</footer>
  )
}
